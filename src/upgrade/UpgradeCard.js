...
export default class UpgradeCard extends PureComponent {
    ...
    onFirstNameValid = firstName => /^[a-zA-Z\s'.-]{2,30}$/.test(firstName);

    onLastNameValid = lastName => /^[a-zA-Z\s'.-]{2,30}$/.test(lastName);

    onDayChange = (e: SyntheticEvent) => this.setState({ day: e.target.value });
    ...
    onCountryChange = (e: SyntheticEvent) => {
        ...
        api
            .getStatesForCountry(e.target.value)
            .then(response =>
    ...
    performUpgrade = async () => {
        ...
        try {
            ...
            storage.setItem(
                'account',
                JSON.stringify({
                    token: response.new_account_real.oauth_token,
                }),
            );
            window.location = '/';
        } catch (e) {
                ...
                <form onSubmit={this.onFormSubmit}>
                    ...
                    <div className="input-row">
                        <label htmlFor="tnc">
                            ...
                            <M m="I agree to the" />&nbsp;
                            <a
                                href="https://binary.com/terms-and-conditions"
                                target="_blank"
