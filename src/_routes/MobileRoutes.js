...
import ContractDetailsMobile
    from '../contract-details/mobile/ContractDetailsMobile';
...
export default [
    ...
    {
        path: 'contract',
        component: ContractDetailsMobile,
        onEnter: requireAuthOnEnter,
    },
    {
        path: 'statement',
        component: StatementMobile,
        onEnter: requireAuthOnEnter,
    },
    {
        path: 'watchlist',
        component: WatchlistMobile,
        onEnter: requireAuthOnEnter,
    },
    {
        path: 'assets',
        component: AssetPickerMobile,
        onEnter: requireAuthOnEnter,
    },
    {
        path: 'trade-type',
        component: TradeTypePickerMobile,
        onEnter: requireAuthOnEnter,
    },
    {
        path: 'settings',
