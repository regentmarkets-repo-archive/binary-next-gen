...
const returnOnContract = contract =>
	((contract.bid_price - contract.buy_price) * 100 / contract.buy_price).toFixed(2);
				...
				<table>
					...
					<tbody>
						{contract && <tr>
							...
							<td>
								<NumberColored
									value={contract.current_spot}
									isProfit={v => v - contract.entry_spot}
								/>
							</td>
					...
					<tbody>
						...
						<tr>
							<td></td>
							<td>{contract && <NumberColored value={returnOnContract(contract)} />}%</td>
							<td></td>
						</tr>
					</tbody>
					<thead>
