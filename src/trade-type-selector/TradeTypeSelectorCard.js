		...
		return (
			<div>
				<fieldset className="radio-selector">
					<RadioItem label="Rise" name="trade-type" value="CALL" img="/img/trade-higher.svg" onChange={onChangeTradeTypeChanged} />
					<RadioItem label="Fall" name="trade-type" value="PUT" img="/img/trade-lower.svg" onChange={onChangeTradeTypeChanged} />
				</fieldset>
				<fieldset className="radio-selector">
				...
				<fieldset className="radio-selector">
					<RadioItem label="Higher" name="trade-type" value="?1" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
					<RadioItem label="Lower" name="trade-type" value="?2" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
				</fieldset>
				<label>Barrier offset</label><input type="number" defaultValue={123} />(123)
				<fieldset className="radio-selector">
					<RadioItem label="Touches" name="trade-type" value="ONETOUCH" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
					<RadioItem label="Does Not Touch" name="trade-type" value="NOTOUCH" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
				</fieldset>
				<label>Barrier offset</label><input type="number" defaultValue={123} />(123)
				<fieldset className="radio-selector">
					<RadioItem label="Ends Between" name="trade-type" value="EXPIRYRANGE" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
					<RadioItem label="Ends Outside" name="trade-type" value="EXPIRYMISS" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
				</fieldset>
				...
				<fieldset className="radio-selector">
					<RadioItem label="Stays Between" name="trade-type" value="RANGE" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
					<RadioItem label="Goes Outside" name="trade-type" value="UPORDOWN" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
				</fieldset>
				<label>Low barrier offset</label><input type="number" defaultValue={123} />(123)
				<label>High barrier offset</label><input type="number" defaultValue={123} />(123)
				<fieldset className="radio-selector">
					<RadioItem label="Spread Long" name="trade-type" value="SPREADU" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
					<RadioItem label="Spread Short" name="trade-type" value="SPREADD" img="/img/trade-???.svg" onChange={onChangeTradeTypeChanged} />
				</fieldset>
