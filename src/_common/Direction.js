...
const DirectionNone = ({ width, height }) =>
	<rect x={width / 5} y={height / 5 * 2} width={width / 5 * 3} height={height / 5} style={{ fill: 'grey ' }} />;

const DirectionUp = ({ width, height }) =>
	<polygon points={`0,${height} ${width},${height} ${width / 2},${height / 5 * 2}`} style={{ fill: 'green' }} />;

const DirectionDown = ({ width, height }) =>
	<polygon points={`0,${height / 5 * 2} ${width},${height / 5 * 2} ${width / 2},${height}`} style={{ fill: 'red' }} />;
