...
export const changeExaminedAsset = (symbol, subscribe = true) =>
    dispatch => {
        ...
        const digitStats = dispatch(getTicksByCount(symbol, 100, subscribe));
...
export const changeActiveLayout = (tradesCount, layoutN) =>
    (dispatch, getState) => {
        ...
        const firstTradeSymbol =
            ...
            (firstOpenSymbol ? firstOpenSymbol.get('symbol') : assets.getIn([0, 'symbol']));
