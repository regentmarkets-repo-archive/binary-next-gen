export default {
    ...
    "Maximum aggregate payouts on open positions": [
        null,
        "Максимальная совокупная выплата по открытым позициям"
    ],
    "Withdrawal limits": [
        null,
        "Лимиты на вывод"
    ...
    "Your withdrawal limit is {limit} (or equivalent in other currency).": [
        null,
        "Ваш лимит вывода: {limit} (или эквивалентная сумма в другой валюте)."
    ],
    "You have already withdrawn the equivalent of EUR {drawn}.": [
        null,
        "Вы уже вывели сумму, эквивалентную EUR {drawn}."
    ],
    "An additional password can be used to restrict access to the cashier.": [
        null,
        "Можно использовать дополнительный пароль для ограничения доступа к кассе."
    ],
    "Sign In": [
        null,
        "Войти"
    ...
    "{asset} will {type} over next {duration}": [
        null,
        "{asset} {type} в следующие {duration}"
    ],
    "Price": [
        null,
        "Цена"
    ...
    "Should be between 0 and {number}": [
        null,
        "Введите число от 0 до {number}"
    ],
    "Time out must be after today and cannot be more than 6 weeks.": [
        null,
        "Время окончания должно быть позднее сегодняшней даты, но не позже, чем через 6 недель."
    ],
    "Exclude time cannot be less than 6 months and more than 5 years.": [
        null,
        "Период исключения не должен быть менее 6 и более 5 лет."
    ]
}