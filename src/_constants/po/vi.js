export default {
    ...
    "Last 50 Ticks": [
        null,
        "50 lần giao động gần nhất"
    ],
    "Last 100 Ticks": [
        null,
        "100 lần giao động gần nhất"
    ],
    "Last 500 Ticks": [
        null,
        "500 lần giao động gần nhất"
    ],
    "Last 1000 Ticks": [
        null,
        "1000 lần giao động gần nhất"
    ],
    "Exit Full Screen": [
        null,
        "Thoát toàn màn hình"
    ...
    "No digit trades for this asset": [
        null,
        "Không có giao dịch số cho tài sản này"
    ],
    "Lock Cashier": [
        null,
        "Khóa quầy thu ngân"
    ...
    "Barrier must not be empty": [
        null,
        "Barie không được để trống"
    ],
    "Duration is out of range": [
        null,
        "Thời hạn nằm ngoài phạm vi"
    ],
    "Start date invalid, it needs to be five minutes or more in the future": [
        null,
        "Ngày bắt đầu không hợp lệ, cần phải bằng 5 phút hoặc nhiều hơn trong tương lai"
    ],
    "Time format is wrong": [
        null,
        "Định dạng thời gian sai"
    ],
    "Lower than": [
        null,
        "Thấp hơn"
    ...
    "Should be between 0 and {number}": [
        null,
        "Nên trong khoảng từ 0 đến {number}"
    ],
    "Time out must be after today and cannot be more than 6 weeks.": [
        null,
        "Thời hạn phải sau ngày hôm nay và có thể không thể nhiều hơn 6 tuần."
    ],
    "Exclude time cannot be less than 6 months and more than 5 years.": [
        null,
        "Thời gian loại trừ không thể ít hơn 6 tháng và hơn 5 năm."
    ]
}