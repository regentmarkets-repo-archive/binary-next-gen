...
import ContractDetailsContainer
    from '../contract-details/ContractDetailsContainer';
...
export default class ContractDetailsModal extends PureComponent {
    ...
    hideDetails = () => actions.detailsForContract(undefined);

    render() {
        const { contractShown } = this.props;

        return (
            <Modal shown={!!contractShown} onClose={this.hideDetails}>
                <ContractDetailsContainer params={{ id: contractShown }} />
            </Modal>
        );
    }
}
