...
export default () => (
	<div>
		...
		<hr />
		<h4><Link to={`/portfolio-popup`}>Portfolio Popup</Link> | <Link to={`/signup`}>Signup</Link> | <Link to={`/upgrade`}>Upgrade</Link> | <Link to={`/ticks`}>Ticks</Link> | <Link to="/balances">Balances</Link>
</h4>
	</div>
);
